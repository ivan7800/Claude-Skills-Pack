...
- Description: `Claude Code Skills pack for app auditing, debugging, PWA, security, releases, prompts and fiction editing.`
- Topics: `claude-code`, `skills`, `ai-tools`, `prompts`, `github-pages`, `pwa`, `debugging`, `frontend`, `writing`
- License: MIT
